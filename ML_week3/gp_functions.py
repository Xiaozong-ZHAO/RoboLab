...
def fit_gp_model_1d(X_values, y_values):
    ...
    return gp, X_values, y_values

def create_prediction_range_kp0():
    kp0_range = np.linspace(0.1, 50, 200).reshape(-1, 1)
    return kp0_range

def create_prediction_range_kd0():
    kd0_range = np.linspace(0.0, 5, 200).reshape(-1, 1)
    return kd0_range

def plot_gp_results_1d(kp0_values, kd0_values, tracking_errors, gp_kp0, gp_kd0, x_values_kp, y_values_kp, x_values_kd, y_values_kd):
    ...
    plt.scatter(x_values_kp, y_values_kp, c='blue', s=50, zorder=10, edgecolors=(0, 0, 0), label='Observations')
    ...
    plt.scatter(x_values_kd, y_values_kd, c='blue', s=50, zorder=10, edgecolors=(0, 0, 0), label='Observations')
